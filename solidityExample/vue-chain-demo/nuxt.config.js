...
module.exports = {
     ...
     */
    plugins: ['~plugins/i18n', '~plugins/axios', '~plugins/antd-ui', '~plugins/bus', '~plugins/wallet', '~utils/filter', '~utils/math', '~plugins/avatar', '@/plugins/svg', '@/plugins/router', '~/plugins/vue-clipboard2'],
    ...
    proxy: {
        ...
        '/tx': 'https://test-earth.bcbchain.io',
        '/block_results': 'https://test-earth.bcbchain.io',
        '/block': 'https://test-earth.bcbchain.io'
    },
    /*
     ** Build configuration
     */
